...
import heroImgLandscape from "../../images/hero2Img.jpg";
export default function Hero(props) {
  return (
    <Container>
      <HeroTitle>
        <Text>¿Te gustaría trabajar en Alemania?</Text>
      </HeroTitle>
      <ArrowDiv
        onClick={() => {
          const offset = 0;
          const bodyRect = document.body.getBoundingClientRect().top;
          const elementRect = props.bg1Ref.current.getBoundingClientRect().top;
